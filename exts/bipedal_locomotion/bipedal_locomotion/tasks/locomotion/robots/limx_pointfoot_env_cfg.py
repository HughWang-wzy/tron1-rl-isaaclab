...
class RewardsCfg:
    ...
    pen_base_height = RewTerm(func=mdp.base_com_height, params={"target_height": 0.65}, weight=-20.0)
    ...
    pen_feet_distance = RewTerm(
        func=mdp.feet_distance, weight=-100, params={"min_feet_distance": 0.115, "feet_links_name": ["foot_[RL]_Link"]}
    )
...
@configclass
class PFBaseEnvCfg(ManagerBasedRLEnvCfg):
    """Base pointfoot env cfg defined locally to avoid deep inheritance chains."""
